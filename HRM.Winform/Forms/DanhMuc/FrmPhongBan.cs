...
namespace HRM.Winform.Forms.DanhMuc
{
    public partial class FrmPhongBan : Form
    {
        ...
        {
            CaiDatGrid();
            _gridHelper ??= new HRM.Winform.Helpers.DataGridSearchPaginationHelper(dgvPhongBan);
            TaiDuLieu();
            LamMoi();
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            bool daTonTai = db.PhongBans.Any(x => x.MaPhongBan == ma);
            if (daTonTai)
            {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            bool daTonTai = db.PhongBans.Any(x => x.MaPhongBan == ma && x.Id != _idDangChon);
            if (daTonTai)
            {
                MessageBox.Show("Mã phòng ban đã tồn tại!");
                txtMaPhongBan.Focus();
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            DialogResult rs = MessageBox.Show("Bạn có chắc muốn xóa phòng ban này không?", "Xác nhận", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
