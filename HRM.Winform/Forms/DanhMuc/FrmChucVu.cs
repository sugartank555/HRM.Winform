...
namespace HRM.Winform.Forms.DanhMuc
{
    public partial class FrmChucVu : Form
    {
        ...
        {
            CaiDatGrid();
            _gridHelper ??= new HRM.Winform.Helpers.DataGridSearchPaginationHelper(dgvChucVu);
            TaiDuLieu();
            LamMoi();
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            DialogResult rs = MessageBox.Show("Bạn có chắc muốn xóa chức vụ này không?", "Xác nhận", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
