...
IF NOT EXISTS (SELECT 1 FROM CaLamViecs WHERE MaCa = 'CA01')
    INSERT INTO CaLamViecs (MaCa, TenCa, GioBatDau, GioKetThuc, SoPhutNghi, SoPhutChoPhepDiMuon, SoPhutChoPhepVeSom, QuaDem, HoatDong, NgayTao, NgayCapNhat)
...
PRINT N'Da them du lieu mau 10 nhan vien.';
PRINT N'Tai khoan: admin, hr001, kt001, it001, kd001...';
